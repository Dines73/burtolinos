    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (draft.username.value.length > 30) {
          ...
          draft.username.message = "Username max 30 characters"
        }
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "You need a valid email address"
        }
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password max 50 characters!"
        }
        return
      case "passwordAfterDelay":
        if (draft.password.value.length < 12) {
          draft.password.hasErrors = true
          draft.password.message = "Password min 12 characters!"
        }
        return
      case "submitForm":
    ...
    if (state.username.checkCount) {
      ...
      async function fetchResults() {
        try {
          ...
          console.log("Problem or the request was cancelled.")
        }
      }
      fetchResults()
    ...
    <Page title="Welcome!" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          <h1 className="display-3">Let us talk about React!</h1>
          <p className="lead text-muted">Hallo! My name is Edin and this is my React-playground</p>
        </div>
